...
describe('update', function () {
  ...
  it('should return updated value and value before updated', function() {
    const cls = new Cls(lib.options)
    let p = cls.update('james-bond', altBody, { withSource: true })
    return Promise.all([
      expect(p).to.eventually.have.property('data').that.include(altBody),
